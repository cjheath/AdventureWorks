...
(
	...
	Hub_ProdNum_SQN      numeric(12)  NULL ,
	CONSTRAINT PK_ShoppingCartItem_ShoppingCartItemID PRIMARY KEY  CLUSTERED (Lnk_ProdNum_ShopCartItemID_SQN ASC),
	 FOREIGN KEY (Hub_ShopCartItemID_SQN) REFERENCES Hub_ShopCartItemID(Hub_ShopCartItemID_SQN),
 FOREIGN KEY (Hub_ProdNum_SQN) REFERENCES Hub_ProdNum(Hub_ProdNum_SQN)
)
go
...
(
	...
	CONSTRAINT PK_ProductProductPhoto_ProductID_ProductPhotoID PRIMARY KEY  NONCLUSTERED (Lnk_ProdNum_ProdPhotoID_SQN ASC,Sat_ProdNum_ProdPhotoID_LDTS ASC),
...
(
	...
	CONSTRAINT PK_SpecialOfferProduct_SpecialOfferID_ProductID PRIMARY KEY  CLUSTERED (Lnk_ProdNum_SOrdNum_SOfrID_SQN ASC,Sat_ProdNum_SOrdNum_SOfrID_LDTS ASC),
...
(
	...
	CONSTRAINT PK_TransactionHistory_TransactionID PRIMARY KEY  CLUSTERED (Hub_TransID_SQN ASC,Sat_TransHist_LDTS ASC),
...
(
	...
	CONSTRAINT PK_TransactionHistory_TransactionID PRIMARY KEY  CLUSTERED (Lnk_ProdNum_TransID_SQN ASC),
	 FOREIGN KEY (Hub_TransID_SQN) REFERENCES Hub_TransID(Hub_TransID_SQN),
 FOREIGN KEY (Hub_ProdNum_SQN) REFERENCES Hub_ProdNum(Hub_ProdNum_SQN)
)
go
...
(
	...
	CONSTRAINT PK_ProductInventory_ProductID_LocationID PRIMARY KEY  CLUSTERED (Lnk_ProdNum_LocID_SQN ASC,Sat_Prod_Loc_LDTS ASC),
...
(
	...
	CONSTRAINT PK_ProductDescription_ProductDescriptionID PRIMARY KEY  CLUSTERED (Hub_ProdDescID_SQN ASC,Sat_ProdDesc_LDTS ASC),
...
(
	...
	CONSTRAINT PK_ProductModelProductDescriptionCulture_ProductModelID_ProductD PRIMARY KEY  CLUSTERED (Lnk_ModID_ProdDescID_CultID_SQN ASC,Sat_Mod_ProdDesc_Cult_LDTS ASC),
...
(
	...
	CONSTRAINT PK_ProductModelIllustration_ProductModelID_IllustrationID PRIMARY KEY  CLUSTERED (Lnk_ModID_IllID_SQN ASC,Sat_ProdMod_Ill_LDTS ASC),
...
(
	...
	CONSTRAINT PK_PurchaseOrderHeader_PurchaseOrderID PRIMARY KEY  CLUSTERED (Hub_POID_SQN ASC,Sat_POHead_LDTS ASC),
...
(
	...
	CONSTRAINT PK_PersonCreditCard_BusinessEntityID_CreditCardID PRIMARY KEY  CLUSTERED (Lnk_PersID_CCID_SQN ASC,Sat_PersID_CCID_LDTS ASC),
...
(
	...
	CONSTRAINT PK_SalesOrderHeader_SalesOrderID PRIMARY KEY  CLUSTERED (Hub_SOrdNum_SQN ASC,Sat_SOrd_LDTS ASC),
	 FOREIGN KEY (Hub_SOrdNum_SQN) REFERENCES Hub_SOrdNum(Hub_SOrdNum_SQN)
)
go
...
(
	...
	CONSTRAINT PK_EmailAddress_BusinessEntityID_EmailAddressID PRIMARY KEY  CLUSTERED (Lnk_PersID_EmailAddID_SQN ASC),
	 FOREIGN KEY (Hub_PersID_SQN) REFERENCES Hub_PersID(Hub_PersID_SQN),
...
(
	...
	CONSTRAINT PK_ProductVendor_ProductID_BusinessEntityID PRIMARY KEY  CLUSTERED (Lnk_ProdNum_VendNum_UntMsrCd_SQN ASC,Sat_ProdNum_VendNum_UntMsrCd_LDTS ASC),
...
(
	...
	CONSTRAINT PK_PhoneNumberType_PhoneNumberTypeID PRIMARY KEY  CLUSTERED (Hub_PNTID_SQN ASC,Sat_PNT_LDTS ASC),
...
(
	...
	CONSTRAINT PK_PersonPhone_BusinessEntityID_PhoneNumber_PhoneNumberTypeID PRIMARY KEY  CLUSTERED (Hub_Phon_SQN ASC,Sat_Phon_LDTS ASC),
...
(
	...
	CONSTRAINT PK_EmailAddress_BusinessEntityID_EmailAddressID PRIMARY KEY  CLUSTERED (Hub_EmailAddID_SQN ASC,Sat_EmailAdd_LDTS ASC),
	 FOREIGN KEY (Hub_EmailAddID_SQN) REFERENCES Hub_EmailAddID(Hub_EmailAddID_SQN)
)
go
...
(
	...
	CONSTRAINT PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID PRIMARY KEY  CLUSTERED (Lnk_ProdNum_POID_SQN ASC,Sat_PODetail_LDTS ASC),
...
(
	...
	CONSTRAINT PK_BillOfMaterials_BillOfMaterialsID PRIMARY KEY  NONCLUSTERED (Hub_BOMID_SQN ASC,Sat_BOM_LDTS ASC),
...
(
	...
	CONSTRAINT PK_StateProvince_StateProvinceID PRIMARY KEY  CLUSTERED (Hub_StProvID_SQN ASC,Sat_StProv_LDTS ASC),
	 FOREIGN KEY (Hub_StProvID_SQN) REFERENCES Hub_StProvID(Hub_StProvID_SQN)
)
go
...
(
	...
	CONSTRAINT PK_SalesPerson_BusinessEntityID PRIMARY KEY  CLUSTERED (Hub_SalePers_SQN ASC,Sat_SalePersLDTS ASC),
	 FOREIGN KEY (Hub_SalePers_SQN) REFERENCES Hub_SalePers(Hub_SalePers_SQN)
)
go
...
(
	...
	CONSTRAINT PK_BusinessEntity_BusinessEntityID PRIMARY KEY  CLUSTERED (Hub_BusEntID_SQN ASC,Sat_BusEntID_LDTS ASC),
	 FOREIGN KEY (Hub_BusEntID_SQN) REFERENCES Hub_BusEntID(Hub_BusEntID_SQN)
)
go
...
(
	...
	CONSTRAINT PK_CountryRegion_CountryRegionCode PRIMARY KEY  CLUSTERED (Hub_CntryRgnCd_SQN ASC,Sat_CntryRgn_LDTS ASC),
	 FOREIGN KEY (Hub_CntryRgnCd_SQN) REFERENCES Hub_CntryRgnCd(Hub_CntryRgnCd_SQN)
)
go
